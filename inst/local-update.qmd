...
When using `bcdc_query_geodata()` with `filter()`, you
sometimes want to include a function call in your
`filter()` statement which should be evaluated locally -
i.e., it's an R function, not a function to be executed
