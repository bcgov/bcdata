...
test_that("bcdc_group works", {
  skip_on_cran()
  skip_if_net_down()

  expect_s3_class(bcdc_group('environmental-reporting-bc'), "bcdc_group")
  expect_s3_class(bcdc_group('environmental-reporting-bc'), "tbl_df")
