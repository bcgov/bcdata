...
getwd()
#> [1] "/Users/runner/runners/2.165.2/work/bcdata/bcdata/vignettes"
```
...
#> geometry type:  POLYGON
#> dimension:      XY
#> bbox:           xmin: 1232157 ymin: 463112.6 xmax: 1236660 ymax: 464253
#> epsg (SRID):    3005
#> proj4string:    +proj=aea +lat_1=50 +lat_2=58.5 +lat_0=45 +lon_0=-126 +x_0=1000000 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs
#> # A tibble: 6 x 20
#>   id    LOCAL_REG_GREEN… PARK_NAME PARK_TYPE PARK_PRIMARY_USE REGIONAL_DISTRI…
#>   <chr>            <int> <chr>     <chr>     <chr>            <chr>           
#> 1 WHSE…               10 53E - Gr… Local     Green Space      Metro Vancouver 
#> 2 WHSE…               11 53F - Gr… Local     Green Space      Metro Vancouver 
#> 3 WHSE…               12 53G - Gr… Local     Green Space      Metro Vancouver 
#> 4 WHSE…               13 53H - Gr… Local     Green Space      Metro Vancouver 
#> 5 WHSE…               14 55A - Ut… Local     Green Space      Metro Vancouver 
#> 6 WHSE…               15 55B - Gr… Local     Green Space      Metro Vancouver 
