...
#> 1 BC Geographic Warehouse… https://catalogue.data.gov.bc.ca/api/ofi/other/WHSE_TANTALIS.T… 529507c4-d155-4c4d-a… other  ""    78ec5279-4534-49a1-97e8… bcgeographicwa… FALSE           
#> 2 WMS getCapabilities req… https://openmaps.gov.bc.ca/geo/pub/WHSE_TANTALIS.TA_SCHOOL_DIS… 57d8843b-5278-4a0f-b… wms    ""    78ec5279-4534-49a1-97e8… bcgeographicwa… TRUE            
#> 3 KML Network Link         http://openmaps.gov.bc.ca/kml/geo/layers/WHSE_TANTALIS.TA_SCHO… 7493e749-0e16-440c-9… kml    kml   78ec5279-4534-49a1-97e8… bcgeographicwa… FALSE
```
...
#> proj4string:    +proj=aea +lat_1=50 +lat_2=58.5 +lat_0=45 +lon_0=-126 +x_0=1000000 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs
#> # A tibble: 3 x 10
#>   id                 ADMIN_AREA_SID SCHOOL_DISTRICT_… SCHOOL_DISTRICT_N… FEATURE_CODE FEATURE_AREA_SQM FEATURE_LENGTH_M OBJECTID SE_ANNO_CAD_DATA                              geometry
#>   <chr>                       <int> <chr>                          <int> <chr>                   <dbl>            <dbl>    <int> <chr>                               <MULTIPOLYGON [m]>
#> 1 WHSE_TANTALIS.TA_…            133 Prince George                     57 FA91800600       52156022749.         2170693.       13 <NA>             (((1139512 1219856, 1139379 1219892,…
#> 2 WHSE_TANTALIS.TA_…            157 Greater Victoria                  61 FA91800600         112290667.          162930.       37 <NA>             (((1188094 392987.8, 1187514 392967.…
#> 3 WHSE_TANTALIS.TA_…            167 Kamloops/Thompson                 73 FA91800600       26181564963.         1202467.       47 <NA>             (((1393261 890465.4, 1393261 890465.…
```
...
#>   name     url         id      format ext   package_id   location  bcdata_available
#>   <chr>    <chr>       <chr>   <chr>  <chr> <chr>        <chr>     <lgl>           
#> 1 BC Geog… https://ca… dac897… other  ""    6a2fea1b-0c… bcgwdata… FALSE           
#> 2 WMS get… https://op… a8d5b5… wms    ""    6a2fea1b-0c… bcgeogra… TRUE            
#> 3 KML Net… http://ope… a7454e… kml    kml   6a2fea1b-0c… bcgeogra… FALSE           
#> 4 LocalRe… https://ca… 766631… xlsx   xlsx  6a2fea1b-0c… external  TRUE
```
...
#> 3 WHSE…               21 Bear Cre… Local     Park             Metro Vancouver 
#> 4 WHSE…               22 Beaver C… Local     Park             Metro Vancouver 
#> 5 WHSE…               23 Bel-Air … Local     Park             Metro Vancouver 
#> 6 WHSE…               24 Bell Est… Local     Park             Metro Vancouver 
#> # … with 14 more variables: MUNICIPALITY <chr>, CIVIC_NUMBER <int>,
#> #   CIVIC_NUMBER_SUFFIX <chr>, STREET_NAME <chr>, LATITUDE <dbl>, LONGITUDE <dbl>,
#> #   WHEN_UPDATED <chr>, WEBSITE_URL <chr>, LICENCE_COMMENTS <chr>,
...
#>   id    LOCAL_REG_GREEN… PARK_NAME PARK_TYPE PARK_PRIMARY_USE REGIONAL_DISTRI…
#>   <chr>            <int> <chr>     <chr>     <chr>            <chr>           
#> 1 WHSE…               20 50B - Ut… Local     Park             Metro Vancouver 
...
#> 5 WHSE…               24 Bell Est… Local     Park             Metro Vancouver 
#> 6 WHSE…               25 Bell Park Local     Park             Metro Vancouver 
#> # … with 14 more variables: MUNICIPALITY <chr>, CIVIC_NUMBER <int>,
#> #   CIVIC_NUMBER_SUFFIX <chr>, STREET_NAME <chr>, LATITUDE <dbl>, LONGITUDE <dbl>,
#> #   WHEN_UPDATED <chr>, WEBSITE_URL <chr>, LICENCE_COMMENTS <chr>,
#> #   FEATURE_AREA_SQM <dbl>, FEATURE_LENGTH_M <dbl>, OBJECTID <int>,
...
#> # … with 9 more variables: SOURCE_DATA_ID <chr>, SUPPLIED_SOURCE_ID_IND <chr>,
#> #   AIRPORT_NAME <chr>, LOCALITY <chr>, LATITUDE <dbl>, LONGITUDE <dbl>,
