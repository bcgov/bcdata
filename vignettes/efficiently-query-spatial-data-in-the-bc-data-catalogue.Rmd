...
#> geometry type:  MULTIPOLYGON
#> dimension:      XY
#> bbox:           xmin: 1227981 ymin: 451450.3 xmax: 1233820 ymax: 467084.5
#> CRS:            3005
#> # A tibble: 6 x 20
#>   id    LOCAL_REG_GREEN… PARK_NAME PARK_TYPE PARK_PRIMARY_USE REGIONAL_DISTRI…
#>   <chr>            <int> <chr>     <chr>     <chr>            <chr>           
#> 1 WHSE…               24 Bell Est… Local     Park             Metro Vancouver 
#> 2 WHSE…               25 Bell Park Local     Park             Metro Vancouver 
#> 3 WHSE…               26 Ben Stev… Local     Park             Metro Vancouver 
#> 4 WHSE…               27 Berkshir… Local     Park             Metro Vancouver 
#> 5 WHSE…               28 Betty Hu… Local     Park             Metro Vancouver 
#> 6 WHSE…               29 Blackie … Local     Green Space      Metro Vancouver 
...
#> geometry type:  MULTIPOLYGON
#> dimension:      XY
#> bbox:           xmin: 1228590 ymin: 451450.3 xmax: 1234562 ymax: 467084.5
#> CRS:            3005
#> # A tibble: 6 x 20
#>   id    LOCAL_REG_GREEN… PARK_NAME PARK_TYPE PARK_PRIMARY_USE REGIONAL_DISTRI…
#>   <chr>            <int> <chr>     <chr>     <chr>            <chr>           
...
#> 4 WHSE…               27 Berkshir… Local     Park             Metro Vancouver 
#> 5 WHSE…               28 Betty Hu… Local     Park             Metro Vancouver 
#> 6 WHSE…               30 Blumsen … Local     Park             Metro Vancouver 
#> # … with 14 more variables: MUNICIPALITY <chr>, CIVIC_NUMBER <int>,
#> #   CIVIC_NUMBER_SUFFIX <chr>, STREET_NAME <chr>, LATITUDE <dbl>,
#> #   LONGITUDE <dbl>, WHEN_UPDATED <date>, WEBSITE_URL <chr>,
#> #   LICENCE_COMMENTS <chr>, FEATURE_AREA_SQM <dbl>, FEATURE_LENGTH_M <dbl>,
