...
The value of `bcdata.max_geom_pred_size` is set consertivately so that requests to the Web Service are more consistently successful. Increasing this value may result in invalid requests. 
