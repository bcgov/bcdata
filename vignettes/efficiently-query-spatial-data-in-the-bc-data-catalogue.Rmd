...
#> Projected CRS: NAD83 / BC Albers
#> # A tibble: 6 x 12
#>   id       CUSTODIAN_ORG_DESCR~ BUSINESS_CATEGO~ BUSINESS_CATEGO~ OCCUPANT_TYPE_D~ SOURCE_DATA_ID
#>   <chr>    <chr>                <chr>            <chr>            <chr>            <chr>         
#> 1 WHSE_IM~ "Ministry of Forest~ airTransportati~ Air Transportat~ BC Airports      455           
#> 2 WHSE_IM~ "Ministry of Forest~ airTransportati~ Air Transportat~ BC Airports      464           
#> 3 WHSE_IM~ "Ministry of Forest~ airTransportati~ Air Transportat~ BC Airports      482           
#> 4 WHSE_IM~ "Ministry of Forest~ airTransportati~ Air Transportat~ BC Airports      483           
#> 5 WHSE_IM~ "Ministry of Forest~ airTransportati~ Air Transportat~ BC Airports      484           
#> 6 WHSE_IM~ "Ministry of Forest~ airTransportati~ Air Transportat~ BC Airports      487           
