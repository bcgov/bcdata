...
#> 1 BC Geograp… https://catalogue.d… 529507c4… other  ""    78ec5279-4534… bcgeograp… FALSE           
#> 2 WMS getCap… https://openmaps.go… 57d8843b… wms    ""    78ec5279-4534… bcgeograp… TRUE            
#> 3 KML Networ… http://openmaps.gov… 7493e749… kml    "kml" 78ec5279-4534… bcgeograp… FALSE           
...
#>   name        url                  id        format ext   package_id     location   bcdata_available
#>   <chr>       <chr>                <chr>     <chr>  <chr> <chr>          <chr>      <lgl>           
#> 1 WMS getCap… https://openmaps.go… a8d5b53e… wms    ""    6a2fea1b-0cc4… bcgeograp… TRUE            
#> 2 KML Networ… http://openmaps.gov… a7454e41… kml    "kml" 6a2fea1b-0cc4… bcgeograp… FALSE           
#> 3 LocalRegio… https://catalogue.d… 76663191… xlsx   "xls… 6a2fea1b-0cc4… external   TRUE            
#> 4 BC Geograp… https://catalogue.d… 53c6c6bd… other  ""    6a2fea1b-0cc4… bcgeograp… FALSE           
#> You can access the 'Resources' data frame using bcdc_tidy_resources()
```
...
#> Projected CRS: NAD83 / BC Albers
#> # A tibble: 6 x 12
#>   id        CUSTODIAN_ORG_DESCRI… BUSINESS_CATEGOR… BUSINESS_CATEGO… OCCUPANT_TYPE_D… SOURCE_DATA_ID
#>   <chr>     <chr>                 <chr>             <chr>            <chr>            <chr>         
#> 1 WHSE_IMA… "Ministry of Forest,… airTransportation Air Transportat… BC Airports      455           
#> 2 WHSE_IMA… "Ministry of Forest,… airTransportation Air Transportat… BC Airports      464           
#> 3 WHSE_IMA… "Ministry of Forest,… airTransportation Air Transportat… BC Airports      482           
#> 4 WHSE_IMA… "Ministry of Forest,… airTransportation Air Transportat… BC Airports      483           
#> 5 WHSE_IMA… "Ministry of Forest,… airTransportation Air Transportat… BC Airports      484           
#> 6 WHSE_IMA… "Ministry of Forest,… airTransportation Air Transportat… BC Airports      487           
