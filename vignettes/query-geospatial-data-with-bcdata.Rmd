---
title: "Query Geospatial Data with bcdata"
...
First you need to load the `bcdata` package. We will also load the `sf` package to better enable our spatial data work:
