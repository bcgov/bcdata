...
First, we can use the `bcdata` package to preview and then download the spatial boundary for the Prince George Natural Resource District. We can use `bcdc_preview()` to interactively preview a [Web Service-enabled](https://www2.gov.bc.ca/gov/content?id=95D78D544B244F34B89223EF069DF74E) geospatial data set from the B.C. Data Catalogue:
