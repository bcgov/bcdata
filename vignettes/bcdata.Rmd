...
#> 1  license_id    62                           Statistics Canada Open Licence
...
#> 7  license_id  1566               Open Government Licence - British Columbia
#> 8  license_id     2                  Open Government Licence - BC Assessment
#> 9  license_id     2                   Open Data Licence for ICBC Information
#> 10 license_id     2 Open Data Commons - Public Domain Dedication and Licence
#> 11 license_id    15                           Elections BC Open Data Licence
#> 12 license_id  1361                                              Access Only
#>    name
#> 1    21
#> 2    25
#> 3    48
...
#> Name: bc-first-tire-recycling-data-1991-2006 (ID:
#>  a29ad492-29a2-44b9-8693-d27a8cc8e686)
#> Permalink:
#>  https://catalogue.data.gov.bc.ca/dataset/a29ad492-29a2-44b9-8693-d27a8cc8e686
#> Sector: Natural Resources
#> Licence: Open Government Licence - British Columbia
#> Type: Dataset
#> Description: Financial Incentives for Recycling Scrap Tires (FIRST)
#>  collection and recycling data (tonnes) from 1991 to 2006. In 2007
#>  [Tire Stewardship BC](http://www.tsbc.ca/), a not for profit society,
#>  launched the new scrap tire recycling program replacing the
#>  government-run program that had been in place since 1991. Tire
#>  Stewardship BC collection and recycling data is available
...
#> # A tibble: 894 x 17
#>    links_bchighwaycam links_imageDispl… links_imageThumb… links_replayThe…    id
#>    <chr>              <chr>             <chr>             <chr>            <dbl>
#>  1 http://images.dri… http://images.dr… http://images.dr… http://images.d…     2
#>  2 http://images.dri… http://images.dr… http://images.dr… http://images.d…     5
#>  3 http://images.dri… http://images.dr… http://images.dr… http://images.d…     6
#>  4 http://images.dri… http://images.dr… http://images.dr… http://images.d…     7
#>  5 http://images.dri… http://images.dr… http://images.dr… http://images.d…     8
#>  6 http://images.dri… http://images.dr… http://images.dr… http://images.d…     9
#>  7 http://images.dri… http://images.dr… http://images.dr… http://images.d…    10
#>  8 http://images.dri… http://images.dr… http://images.dr… http://images.d…    11
#>  9 http://images.dri… http://images.dr… http://images.dr… http://images.d…    12
#> 10 http://images.dri… http://images.dr… http://images.dr… http://images.d…    13
#> # … with 884 more rows, and 12 more variables: highway_number <chr>,
...
#> #   updatePeriodMean <dbl>, updatePeriodStdDev <dbl>
...
#> Name: bc-schools-programs-offered-in-schools (ID:
#>  b1f27d1c-244a-410e-a361-931fac62a524)
#> Permalink:
#>  https://catalogue.data.gov.bc.ca/dataset/b1f27d1c-244a-410e-a361-931fac62a524
#> Sector: Education
#> Licence: Open Government Licence - British Columbia
#> Type: Dataset
#> Description: BC Schools English Language Learners, French Immersion,
#>  Francophone, Career Preparation, Aboriginal Support Services,
#>  Aboriginal Language and Culture, Continuing Education and Career
#>  Technical Programs offered in BC schools up to 2013/2014.
...
#>    `Data Level` `School Year` `Facility Type` `Public Or Indep… `District Numbe…
#>    <chr>        <chr>         <chr>           <chr>             <chr>           
...
#> #   School Number <chr>, School Name <chr>, Has Eng Lang Learner Prog <lgl>,
#> #   Has Core French <lgl>, Has Early French Immersion <lgl>,
...
#> #   Has Distributed Learn Prog <lgl>, Has Career Prep Prog <lgl>,
#> #   Has Coop Prog <lgl>, Has Apprenticeship Prog <lgl>,
...
#> Number of records: 1
#> Titles:
#> 1: Regional Districts - Legally Defined Administrative Areas of BC
#>  (other, xlsx, wms, kml)
