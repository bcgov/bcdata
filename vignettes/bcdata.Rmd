...
#> 7  license_id  1567               Open Government Licence - British Columbia    2
...
#> 12 license_id  1390                                              Access Only   22
```
...
#> 1 Program… http://www.b… a393f8cf… txt    txt   b1f27d1c-24… external FALSE         TRUE            
#> 2 Program… http://www.b… 1e34098e… xlsx   xlsx  b1f27d1c-24… external FALSE         TRUE
```
...
my_regional_district  %>%
  ...
  geom_sf() +
  theme_minimal()
#> Error in ggplot(.): object 'my_regional_district' not found
```
