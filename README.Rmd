...
[![R build status](https://github.com/bcgov/bcdata/workflows/R-CMD-check/badge.svg)](https://github.com/bcgov/bcdata/actions?workflow=R-CMD-check)
...
[![CRAN\_Status\_Badge](https://www.r-pkg.org/badges/version/bcdata)](https://cran.r-project.org/package=bcdata) [![CRAN Downloads](https://cranlogs.r-pkg.org/badges/bcdata?color=brightgreen)](https://CRAN.R-project.org/package=bcdata) [![cran checks](https://cranchecks.info/badges/worst/bcdata)](https://cran.rstudio.com/web/checks/check_results_bcdata.html)
<!-- badges: end -->
...
### Installation
You can install `bcdata` v0.1.1 directly from [CRAN](https://cran.r-project.org/package=bcdata): 
