...
- [`bcdc_tidy_resources()`](https://bcgov.github.io/bcdata/dev/reference/bcdc_tidy_resources.md) -
  Get a data frame of resources for a record
...
- [`bcdc_query_geodata()`](https://bcgov.github.io/bcdata/dev/reference/bcdc_query_geodata.md) -
  Get & query catalogue geospatial data available through a [Web Feature
...
The
[`bcdc_query_geodata()`](https://bcgov.github.io/bcdata/dev/reference/bcdc_query_geodata.md)
returns an object of the class `bcdc_promise`. We have written an ever
growing list methods for this class. You can use these methods directly
on a object returned by
[`bcdc_query_geodata()`](https://bcgov.github.io/bcdata/dev/reference/bcdc_query_geodata.md).
