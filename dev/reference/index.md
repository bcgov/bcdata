...
- [`bcdc_browse()`](https://bcgov.github.io/bcdata/dev/reference/bcdc_browse.md)
...
- [`bcdc_search_facets()`](https://bcgov.github.io/bcdata/dev/reference/bcdc_search_facets.md)
  :

  Get the valid values for a facet (that you can use in
  [`bcdc_search()`](https://bcgov.github.io/bcdata/dev/reference/bcdc_search.md))

- [`bcdc_list()`](https://bcgov.github.io/bcdata/dev/reference/bcdc_list.md)
...
- [`bcdc_list_groups()`](https://bcgov.github.io/bcdata/dev/reference/bcdc_list_group_records.md)
  [`bcdc_list_group_records()`](https://bcgov.github.io/bcdata/dev/reference/bcdc_list_group_records.md)
  : Retrieve group information for B.C. Data Catalogue

- [`bcdc_list_organizations()`](https://bcgov.github.io/bcdata/dev/reference/bcdc_list_organization_records.md)
  [`bcdc_list_organization_records()`](https://bcgov.github.io/bcdata/dev/reference/bcdc_list_organization_records.md)
  : Retrieve organization information for B.C. Data Catalogue

- [`bcdc_get_citation()`](https://bcgov.github.io/bcdata/dev/reference/bcdc_get_citation.md)
...
- [`bcdc_preview()`](https://bcgov.github.io/bcdata/dev/reference/bcdc_preview.md)
...
- [`select(`*`<bcdc_promise>`*`)`](https://bcgov.github.io/bcdata/dev/reference/select.md)
  : Select columns from bcdc_query_geodata() call

- [`mutate(`*`<bcdc_promise>`*`)`](https://bcgov.github.io/bcdata/dev/reference/mutate.md)
  :

  Throw an informative error when attempting mutate on a `bcdc_promise`
  object

- [`collect(`*`<bcdc_promise>`*`)`](https://bcgov.github.io/bcdata/dev/reference/collect-methods.md)
  [`as_tibble(`*`<bcdc_promise>`*`)`](https://bcgov.github.io/bcdata/dev/reference/collect-methods.md)
  : as_tibble

- [`EQUALS()`](https://bcgov.github.io/bcdata/dev/reference/cql_geom_predicates.md)
  [`DISJOINT()`](https://bcgov.github.io/bcdata/dev/reference/cql_geom_predicates.md)
  [`INTERSECTS()`](https://bcgov.github.io/bcdata/dev/reference/cql_geom_predicates.md)
  [`TOUCHES()`](https://bcgov.github.io/bcdata/dev/reference/cql_geom_predicates.md)
  [`CROSSES()`](https://bcgov.github.io/bcdata/dev/reference/cql_geom_predicates.md)
  [`WITHIN()`](https://bcgov.github.io/bcdata/dev/reference/cql_geom_predicates.md)
  [`CONTAINS()`](https://bcgov.github.io/bcdata/dev/reference/cql_geom_predicates.md)
  [`OVERLAPS()`](https://bcgov.github.io/bcdata/dev/reference/cql_geom_predicates.md)
  [`BBOX()`](https://bcgov.github.io/bcdata/dev/reference/cql_geom_predicates.md)
  [`DWITHIN()`](https://bcgov.github.io/bcdata/dev/reference/cql_geom_predicates.md)
  : CQL Geometry Predicates

- [`bcdc_check_geom_size()`](https://bcgov.github.io/bcdata/dev/reference/bcdc_check_geom_size.md)
  : Check spatial objects for WFS spatial operations

- [`CQL()`](https://bcgov.github.io/bcdata/dev/reference/CQL.md) : CQL
  escaping
